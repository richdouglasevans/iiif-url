...
describe("parse Image Request URI", () => {
  ...
  describe("rainy day", () => {
    ...
    describe("size", () => {
      ...
      test("old 'full' size is no longer supported", () => {
        const result = parseURI(
